    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="p-4 bg-light rounded-3 shadow-sm border-start border-primary border-5">
                ...
                <p class="text-muted mb-0">Selamat datang kembali di sistem pengelolaan <b></b></p>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-footer bg-transparent border-0 text-center pb-3">
                    <a href="<?= base_url('buku'); ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3">Detail</a>
                </div>
            </div>
        </div>
